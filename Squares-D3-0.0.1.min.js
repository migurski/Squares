// D3 retrieved from http://d3js.org/d3.v2.min.js, 2013-02-10
...
// Square.min.js generated from commit b7c9933da5abe77acdea9614acbe6abc4975b13b
var require=function(b,h){var d=require.resolve(b,h||"/"),e=require.modules[d];if(!e)throw Error("Failed to resolve module "+b+", tried "+d);return(d=require.cache[d])?d.exports:e()};require.paths=[];require.modules={};require.cache={};require.extensions=[".js",".coffee",".json"];require._core={assert:!0,events:!0,fs:!0,path:!0,vm:!0};
require.resolve=function(){return function(b,h){function d(a){a=g.normalize(a);if(require.modules[a])return a;for(var c=0;c<require.extensions.length;c++){var b=require.extensions[c];if(require.modules[a+b])return a+b}}function e(a){a=a.replace(/\/+$/,"");var c=g.normalize(a+"/package.json");if(require.modules[c]){var c=require.modules[c](),b=c.browserify;if("object"===typeof b&&b.main){if(c=d(g.resolve(a,b.main)))return c}else if("string"===typeof b){if(c=d(g.resolve(a,b)))return c}else if(c.main&&
(c=d(g.resolve(a,c.main))))return c}return d(a+"/index")}h||(h="/");if(require._core[b])return b;var g=require.modules.path(),c=(h=g.resolve("/",h))||"/";if(b.match(/^(?:\.\.?\/|\/)/)){var a=d(g.resolve(c,b))||e(g.resolve(c,b));if(a)return a}a:{for(var a="/"===c?[""]:g.normalize(c).split("/"),c=[],f=a.length-1;0<=f;f--)if("node_modules"!==a[f]){var j=a.slice(0,f+1).join("/")+"/node_modules";c.push(j)}for(a=0;a<c.length;a++){f=c[a];if(j=d(f+"/"+b)){c=j;break a}if(f=e(f+"/"+b)){c=f;break a}}c=(j=d(b))?
j:void 0}if(c)return c;throw Error("Cannot find module '"+b+"'");}}();require.alias=function(b,h){var d=require.modules.path(),e=null;try{e=require.resolve(b+"/package.json","/")}catch(g){e=require.resolve(b,"/")}for(var d=d.dirname(e),e=(Object.keys||function(c){var a=[],b;for(b in c)a.push(b);return a})(require.modules),c=0;c<e.length;c++){var a=e[c];a.slice(0,d.length+1)===d+"/"?(a=a.slice(d.length),require.modules[h+a]=require.modules[d+a]):a===d&&(require.modules[h]=require.modules[d])}};
(function(){var b={},h="undefined"!==typeof window?window:{},d=!1;require.define=function(e,g){!d&&require.modules.__browserify_process&&(b=require.modules.__browserify_process(),d=!0);var c=require._core[e]?"":require.modules.path().dirname(e),a=function(a){var b=require(a,c);if((a=require.cache[require.resolve(a,c)])&&null===a.parent)a.parent=f;return b};a.resolve=function(a){return require.resolve(a,c)};a.modules=require.modules;a.define=require.define;a.cache=require.cache;var f={id:e,filename:e,
exports:{},loaded:!1,parent:null};require.modules[e]=function(){require.cache[e]=f;g.call(f.exports,a,f,f.exports,c,e,b,h);f.loaded=!0;return f.exports}}})();
require.define("path",function(b,h,d,e,g,c){function a(a,c){for(var b=[],f=0;f<a.length;f++)c(a[f],f,a)&&b.push(a[f]);return b}function f(a,c){for(var b=0,f=a.length;0<=f;f--){var d=a[f];"."==d?a.splice(f,1):".."===d?(a.splice(f,1),b++):b&&(a.splice(f,1),b--)}if(c)for(;b--;b)a.unshift("..");return a}var j=/^(.+\/(?!$)|\/)?((?:.+?)?(\.[^.]*)?)$/;d.resolve=function(){for(var b="",k=!1,d=arguments.length;-1<=d&&!k;d--){var g=0<=d?arguments[d]:c.cwd();"string"===typeof g&&g&&(b=g+"/"+b,k="/"===g.charAt(0))}b=
f(a(b.split("/"),function(a){return!!a}),!k).join("/");return(k?"/":"")+b||"."};d.normalize=function(c){var b="/"===c.charAt(0),d="/"===c.slice(-1);c=f(a(c.split("/"),function(a){return!!a}),!b).join("/");!c&&!b&&(c=".");c&&d&&(c+="/");return(b?"/":"")+c};d.join=function(){var c=Array.prototype.slice.call(arguments,0);return d.normalize(a(c,function(a){return a&&"string"===typeof a}).join("/"))};d.dirname=function(a){return(a=j.exec(a)[1]||"")?1===a.length?a:a.substring(0,a.length-1):"."};d.basename=
function(a,c){var b=j.exec(a)[2]||"";c&&b.substr(-1*c.length)===c&&(b=b.substr(0,b.length-c.length));return b};d.extname=function(a){return j.exec(a)[3]||""};d.relative=function(a,c){function b(a){for(var c=0;c<a.length&&""===a[c];c++);for(var f=a.length-1;0<=f&&""===a[f];f--);return c>f?[]:a.slice(c,f-c+1)}a=d.resolve(a).substr(1);c=d.resolve(c).substr(1);for(var f=b(a.split("/")),g=b(c.split("/")),e=Math.min(f.length,g.length),j=e,m=0;m<e;m++)if(f[m]!==g[m]){j=m;break}e=[];for(m=j;m<f.length;m++)e.push("..");
e=e.concat(g.slice(j));return e.join("/")}});
require.define("__browserify_process",function(b,h,d,e,g,c){c=h.exports={};c.nextTick=function(){if("undefined"!==typeof window&&window.setImmediate)return function(a){return window.setImmediate(a)};if("undefined"!==typeof window&&window.postMessage&&window.addEventListener){var a=[];window.addEventListener("message",function(c){c.source===window&&"browserify-tick"===c.data&&(c.stopPropagation(),0<a.length&&a.shift()())},!0);return function(c){a.push(c);window.postMessage("browserify-tick","*")}}return function(a){setTimeout(a,
...
require.define("/Image.js",function(b,h,d){function e(a){return a.toKey()}function g(a){return a.left()}function c(a){return a.top()}function a(a){return a.width()}function f(a){return a.height()}function j(a){return a.transform()}function l(a){return a.coord.zoom}var k=b("./Mouse"),r=b("./Hash");b("./Base");var n=b("./Tile"),p=b("./Grid");b=function(a,c,b,f,d){this.selection=d3.select(a);this.loaded_tiles={};this.template=c;this.parent=a;a=k.element_size(this.parent);f=b.locationCoordinate(f).zoomTo(d);
this.grid=new p.Grid(a.x,a.y,f,3);this.projection=b;this.queue=new q(this.loaded_tiles);this.tile_queuer=this.getTileQueuer();this.tile_dequeuer=this.getTileDequeuer();this.tile_onloaded=this.getTileOnloaded();k.link_control(this.selection,new k.Control(this,!0));r.link_control(this);var g=this;d3.select(window).on("resize.map",function(){g.update_gridsize()});this.selection.selectAll("img.tile").remove();this.redraw(!0)};b.prototype.update_gridsize=function(){var a=k.element_size(this.parent);this.grid.resize(a.x,
a.y);this.redraw(!0)};b.prototype.pointLocation=function(a){a=this.grid.pointCoordinate(a?a:this.grid.center);return this.projection.coordinateLocation(a)};b.prototype.locationPoint=function(a){a=this.projection.locationCoordinate(a);return this.grid.coordinatePoint(a)};b.prototype.setCenterZoom=function(a,c){this.grid.setCenter(this.projection.locationCoordinate(a,c));this.redraw(!0)};b.prototype.onMoved=function(a){var c=this,b=this.moved_callback;this.moved_callback=function(){b&&b();a(c)}};b.prototype.redraw=
function(b){var d=this.grid.visibleTiles(),d=this.selection.selectAll("img.tile").data(d,e);d.exit().each(this.tile_dequeuer).remove();d.enter().append("img").attr("class","tile").attr("id",e).style("z-index",l).style("display","none").on("load",this.tile_onloaded).each(this.tile_queuer);n.transform_property?this.selection.selectAll("img.tile").style(n.transform_property,j):this.selection.selectAll("img.tile").style("left",g).style("top",c).style("width",a).style("height",f);b&&this.moved_callback&&
this.moved_callback();this.queue.process()};b.prototype.getTileOnloaded=function(){var a=this;return function(){d3.select(this).style("display","block");a.loaded_tiles[this.src]=Date.now();a.queue.close(this);a.redraw(!1)}};b.prototype.getTileQueuer=function(){var a=this;return function(c){var b=a.template,b=b.replace("{z}","{Z}").replace("{Z}",c.coord.zoom.toFixed(0)),b=b.replace("{x}","{X}").replace("{X}",c.coord.column.toFixed(0)),b=b.replace("{y}","{Y}").replace("{Y}",c.coord.row.toFixed(0));
a.queue.append(this,b)}};b.prototype.getTileDequeuer=function(){var a=this.queue;return function(){a.cancel(this)}};d.Map=b;var q;d=function(a){this.queue=[];this.queue_by_id={};this.open_request_count=0;this.requests_by_id={};this.loaded_tiles=a};d.prototype.append=function(a,c){if(c in this.loaded_tiles)a.src=c;else{var b=new s(a,c);this.queue.push(b);this.queue_by_id[b.id]=b}};d.prototype.cancel=function(a){this.close(a);var c=this.queue_by_id[a.id];c&&(c.deny(),delete this.queue_by_id[a.id])};
d.prototype.close=function(a){var c=this.requests_by_id[a.id];c&&(c.deny(),delete this.requests_by_id[a.id],this.open_request_count--)};d.prototype.process=function(){for(this.queue.sort(s.compare);4>this.open_request_count&&0<this.queue.length;){var a=this.queue.shift();a.load()&&(this.requests_by_id[a.id]=a,this.open_request_count++);delete this.queue_by_id[a.id]}};q=d;var s;d=function(a,c){this.id=a.id;this.sort=parseInt(d3.select(a).style("z-index"));this.image=a;this.src=c};d.prototype.deny=
function(){this.image=null};d.prototype.load=function(){return this.image&&this.image.parentNode?(this.image.src=this.src,!0):!1};d.compare=function(a,c){return c.sort-a.sort};s=d});
require.define("/Mouse.js",function(b,h,d){function e(a){var c=a.append("a");c.style("display","block").style("float","left").style("cursor","pointer").style("padding","7px").style("border-radius","3px").style("background-color","white").style("opacity",0.8).on("mouseover.button",function(){c.style("opacity",1)}).on("mouseout.button",function(){c.style("opacity",0.8)});return c}function g(){d3.event.preventDefault();d3.event.stopPropagation()}var c=b("./Core");d.element_size=function(a){return a==
document.body?new c.Point(window.innerWidth,window.innerHeight):new c.Point(a.clientWidth,a.clientHeight)};d.link_control=function(a,c){var b=a.append("div"),d=e(b),k=e(b);d.style("margin-right","5px");b.style("z-index",99).style("position","absolute").style("padding","5px").style("margin","5px").style("background-color","rgba(0, 0, 0, .2)").style("border-radius","6px");k.append("img").style("display","block").style("pointer-events","none").attr("src","data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJAQMAAADaX5RTAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAAZQTFRFAAAA////pdmf3QAAAAJ0Uk5T/wDltzBKAAAAEUlEQVQI12N43MAAQXAAEwEAcZcIUxqnpLsAAAAASUVORK5CYII=");
d.append("img").style("display","block").style("pointer-events","none").attr("src","data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJAQMAAADaX5RTAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAAZQTFRFAAAA////pdmf3QAAAAJ0Uk5T/wDltzBKAAAAEUlEQVQI12P438AAQXAAEwEAescI+0eupfwAAAAASUVORK5CYII=");a.on("dblclick.map",function(){c.onDoubleclick()});a.on("mousedown.map",function(){c.onMousedown()});a.on("mousewheel.map",function(){c.onMousewheel()});a.on("DOMMouseScroll.map",function(){c.onMousewheel()});
...
(b=1);return new e(this.row+b,this.column,this.zoom)};e.prototype.left=function(b){"undefined"===typeof b&&(b=1);return new e(this.row,this.column-b,this.zoom)};d.Coordinate=e});
require.define("/Hash.js",function(b,h,d){function e(a){j||a==l&&(j=window.setTimeout(g,50))}function g(){clearTimeout(j);j=null;var a=l.grid.zoom(),c=Math.round(a).toFixed(2)==a.toFixed(2),b=Math.round(Math.log(1<<a+8)/Math.log(10)),b=Math.max(0,b-2),d=l.pointLocation(null),a=[a.toFixed(c?0:2),d.lat.toFixed(b),d.lon.toFixed(b)];f=!0;location.hash="#"+a.join("/")}function c(){if(f)f=!1;else{var c=location.hash.match(/^#(\d+(?:\.\d+)?)\/(-?\d+(?:\.\d+)?)\/(-?\d+(?:\.\d+)?)$/);if(c){var b=parseFloat(c[1]),
c=new a.Location(parseFloat(c[2]),parseFloat(c[3]));l.setCenterZoom(c,b)}}}var a=b("./Geo"),f=!1,j,l;d.link_control=function(a){l||(l=a,c(),window.addEventListener("hashchange",c),l.onMoved(e))}});
require.define("/Geo.js",function(b,h,d){var e=b("./Core"),g=function(a,c){this.lat=a;this.lon=c};g.prototype.toString=function(){return"("+this.lat.toFixed(6)+", "+this.lon.toFixed(6)+")"};d.Location=g;var c=Math.PI;b=function(){};b.prototype.project=function(a){var b=c*a.lon/180;a=Math.log(Math.tan(c/4+c*a.lat/180/2));return new e.Point(b,a)};b.prototype.inverse=function(a){var b=a.x;a=180*(2*Math.atan(Math.exp(a.y))-c/2)/c;return new g(a,180*b/c)};b.prototype.locationCoordinate=function(a,b){"undefined"===
typeof b&&(b=0);var d=this.project(a);return(new e.Coordinate((c-d.y)/(2*c),(d.x+c)/(2*c),0)).zoomTo(b)};b.prototype.coordinateLocation=function(a){a=a.zoomTo(0);return this.inverse(new e.Point(2*a.column*c-c,c-2*a.row*c))};d.Mercator=b});require.define("/Base.js",function(){});
require.define("/Tile.js",function(b,h,d){function e(c,a,b,e,g){if("WebKitCSSMatrix"in window&&"m11"in new window.WebKitCSSMatrix)return c=c||1,"translate3d("+[a.toFixed(0),b.toFixed(0),"0px"].join("px,")+") scale3d("+[c.toFixed(8),c.toFixed(8),"1"].join()+")";var k="MozTransform"==d.transform_property?"px":"";return"matrix("+[c||"1",0,0,c||"1",a+(e*c-e)+k,b+(g*c-g)+k].join()+")"}var g=b("./Grid");b=function(c,a){this.coord=c;this.grid=a};b.prototype.toString=function(){return[this.coord.toString(),
...
e});
require.define("/Grid.js",function(b,h,d){var e=b("./Core"),g=b("./Tile");d.TileSize=256;d.TileExp=Math.log(d.TileSize)/Math.log(2);b=function(c,a,b,d){this.resize(c,a);this.coord=b;this.pyramid=d};b.prototype.zoom=function(){return this.coord.zoom};b.prototype.roundCoord=function(){return this.coord.zoomTo(Math.round(this.coord.zoom))};b.prototype.resize=function(c,a){this.center=new e.Point(c/2,a/2)};b.prototype.setCenter=function(c){this.coord=18<this.coord.zoom?c.zoomTo(18):0>this.coord.zoom?c.zoomTo(0):
c};b.prototype.panBy=function(c,a){var b=new e.Point(this.center.x-c,this.center.y-a);this.coord=this.pointCoordinate(b)};b.prototype.zoomToAbout=function(c,a){var b=new e.Point(2*this.center.x-a.x,2*this.center.y-a.y);this.coord=this.pointCoordinate(new e.Point(a.x,a.y));this.coord=this.coord.zoomTo(c);18<this.coord.zoom?this.coord=this.coord.zoomTo(18):0>this.coord.zoom&&(this.coord=this.coord.zoomTo(0));this.coord=this.pointCoordinate(b)};b.prototype.coordinatePoint=function(c){var a=this.coord.zoomBy(d.TileExp);
c=c.zoomTo(a.zoom);return new e.Point(this.center.x-a.column+c.column,this.center.y-a.row+c.row)};b.prototype.pointCoordinate=function(c){var a=c.x-this.center.x;c=c.y-this.center.y;return this.coord.zoomBy(d.TileExp).right(a).down(c).zoomTo(this.coord.zoom)};b.prototype.visibleTiles=function(){for(var c=this.roundCoord(),a=this.pointCoordinate(new e.Point(0,0)),b=this.pointCoordinate(new e.Point(2*this.center.x,2*this.center.y)),a=a.zoomTo(c.zoom).container(),b=b.zoomTo(c.zoom).container(),d=[],
h={},k=a.row;k<=b.row;k++)for(var r=a.column;r<=b.column;r++){var n=new e.Coordinate(k,r,c.zoom);d.push(new g.Tile(n,this));for(var p=n.zoom-1;p>=n.zoom-this.pyramid&&0<=p;p--){var q=n.zoomTo(p).container();if(q.toString()in h)break;h[q.toString()]=!0;d.push(new g.Tile(q,this))}}return d};d.Grid=b});
require.define("/Div.js",function(b,h,d){function e(a){return a.toKey()}function g(a){return a.left()}function c(a){return a.top()}function a(a){return a.width()}function f(a){return a.height()}var j=b("./Mouse");b("./Base");var l=b("./Grid");b=function(a,b,c,d){this.selection=d3.select(a);this.parent=a;a=j.element_size(this.parent);c=b.locationCoordinate(c).zoomTo(d);this.grid=new l.Grid(a.x,a.y,c,0);this.projection=b;j.link_control(this.selection,new j.Control(this,!1));var e=this;d3.select(window).on("resize.map",
function(){e.update_gridsize()});this.selection.selectAll("div.tile").remove();this.redraw(!1)};b.prototype.update_gridsize=function(){var a=j.element_size(this.parent);this.grid.resize(a.x,a.y);this.redraw(!0)};b.prototype.pointLocation=function(a){a=this.grid.pointCoordinate(a?a:this.grid.center);return this.projection.coordinateLocation(a)};b.prototype.locationPoint=function(a){a=this.projection.locationCoordinate(a);return this.grid.coordinatePoint(a)};b.prototype.setCenterZoom=function(a,b){this.grid.setCenter(this.projection.locationCoordinate(a,
b));this.redraw(!0)};b.prototype.onMoved=function(a){var b=this,c=this.moved_callback;this.moved_callback=function(){c&&c();a(b)}};b.prototype.redraw=function(b){var d=this.grid.visibleTiles(),d=this.selection.selectAll("div.tile").data(d,e);d.exit().remove();d.enter().append("div").attr("class","tile").style("border-top","1px solid pink").style("border-left","1px solid pink").text(e).attr("id",e);this.selection.selectAll("div.tile").style("left",g).style("top",c).style("width",a).style("height",
f);b&&this.moved_callback&&this.moved_callback()};d.Map=b});
require.define("/Main.js",function(b){var h=b("./Image"),d=b("./Div"),e=b("./Geo");window.squares={makeImgMap:function(b,c,a,d,j){if(b==document.body)throw Error("Sorry, for the moment I can\u2019t figure out how to make the mousewheel work in Safari 5.0 when the parent element is the document body. Try making your parent element a DIV?");return new h.Map(b,c,new e.Mercator,new e.Location(a,d),j)},makeDivMap:function(b,c,a,f){if(b==document.body)throw Error("Sorry, for the moment I can\u2019t figure out how to make the mousewheel work in Safari 5.0 when the parent element is the document body. Try making your parent element a DIV?");return new d.Map(b,
new e.Mercator,new e.Location(c,a),f)},Geo:{Mercator:e.Mercator}};void 0==window.sq&&(window.sq=window.squares)});require("/Main.js");

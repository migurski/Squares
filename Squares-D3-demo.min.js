// D3 v2 retrieved Mon Feb 11 16:51:55 EST 2013
...
// Squares 0.0.2 from commit bdec68b
...
require.define("path",function(b,h,d,e,g,c){function a(a,c){for(var b=[],f=0;f<a.length;f++)c(a[f],f,a)&&b.push(a[f]);return b}function f(a,c){for(var b=0,f=a.length;0<=f;f--){var d=a[f];"."==d?a.splice(f,1):".."===d?(a.splice(f,1),b++):b&&(a.splice(f,1),b--)}if(c)for(;b--;b)a.unshift("..");return a}var j=/^(.+\/(?!$)|\/)?((?:.+?)?(\.[^.]*)?)$/;d.resolve=function(){for(var b="",d=!1,g=arguments.length;-1<=g&&!d;g--){var e=0<=g?arguments[g]:c.cwd();"string"===typeof e&&e&&(b=e+"/"+b,d="/"===e.charAt(0))}b=
...
new e.Mercator,new e.Location(c,a),f)},ImageMap:h.Map,DivMap:d.Map,Geo:{Mercator:e.Mercator}};void 0==window.sq&&(window.sq=window.squares)});require("/Main.js");
